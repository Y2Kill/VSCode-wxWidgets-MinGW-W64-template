...
Toolbar::Toolbar(const wxString& title)
    ...
    wxBitmap exit(wxT("exit_32x32.png"), wxBITMAP_TYPE_PNG);
    wxBitmap newb(wxT("new_32x32.png"), wxBITMAP_TYPE_PNG);
    wxBitmap open(wxT("open_32x32.png"), wxBITMAP_TYPE_PNG);
    wxBitmap save(wxT("save_32x32.png"), wxBITMAP_TYPE_PNG);
